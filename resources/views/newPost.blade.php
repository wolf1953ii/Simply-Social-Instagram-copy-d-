...
@auth()
    ...
    <div class="container" style="margin-top: 5em">
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">Upload new photo to post</div>
                    <div class="card-body">
                        <form id="file-upload-form" action="{{url('save')}}" method="post" enctype="multipart/form-data">
                            @csrf
                        <div class="form-group row justify-content-center">
                            <label for="file">Choose your image</label>
                            <input type="file" class="form-control-file" id="file" name="file" style="margin-left: 10em;">
                        </div>
                            <div class="form-group row justify-content-center">
                            ...
                            <div class="form-group row justify-content-center">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="privacy">Make private</label>
                                </div>
                            </div>
                            <div class="form-group row justify-content-center">
                        <button type="submit" class="btn btn-primary">Post a new image</button>
                            </div>
                        </form>
                    </div>
                </div>
